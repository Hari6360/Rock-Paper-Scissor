...
const rock = `<div class="circle select-none circleh border-blue">
<img class="mx-auto" src="./assets/rock.svg" />
</div>`;

const paper = `<div class="circle select-none circleh border-yellow">
<img class="mx-auto" src="./assets/paper.svg" />
</div>`;

const scissors = `<div class="circle select-none circleh border-purple">
